...
#define TWBR ACCES_REGISTER_ADDRESS(0x00)
#define TWCR ACCES_REGISTER_ADDRESS(0x36)
enum{TWIE, TWEN = 2, TWWC, TWSTO, TWSTA, TWEA, TWINT};

#define TWSR ACCES_REGISTER_ADDRESS(0x01)
enum{TWPS0, TWPS1, TWS3 = 3, TWS4, TWS5, TWS6, TWS7};

#define TWDR ACCES_REGISTER_ADDRESS(0x03)
#define TWAR ACCES_REGISTER_ADDRESS(0x02)
enum{TWGCE, TWA0, TWA1, TWA2, TWA3, TWA4, TWA5, TWA6};
double FCPU;
#define SCL_CLK 100000
#define BITRATE(TWSR)	((FCPU*1000000/SCL_CLK)-16)/(2*pow(4,(TWSR&((1<<TWPS0)|(1<<TWPS1)))))

char decimal_to_bcd(unsigned char value)	//Function convert decimal ke bcd
{
